...
#  if __cplusplus >= 201703L \
      || (DOCTEST_MSVC >= DOCTEST_COMPILER(19, 12, 0) \
          && _MSVC_LANG >= 201703L)
...
#  else  // DOCTEST_CONFIG_DISABLE
#    define DOCTEST_BRANCH_ON_DISABLED(if_disabled, if_not_disabled) \
      if_not_disabled
#  endif  // DOCTEST_CONFIG_DISABLE
...
bool operator==(double lhs, const Approx& rhs)
{
  ...
  return std::fabs(lhs - rhs.m_value) < rhs.m_epsilon
      * (rhs.m_scale
...
std::ostream& file_line_to_stream(std::ostream& s,
                                  const char* file,
                                  int line,
                                  const char* tail = "")
{
